...
| <img src="Resources/Icons/orca.png" alt="icon" width=15 height=15> **Orca** | An open-source agentic development environment (ADE) for running a fleet of parallel AI coding agents — Claude Code, Codex, Cursor, Gemini — each in its own isolated git worktree, with a built-in terminal and source control. | [Website](https://onorca.dev) <br> [Github](https://github.com/stablyai/orca) | `Mac` `Windows` `Linux` | Free, Open-Source | `AI-Native` `Agentic` `Git-Worktree` |
| <img src="Resources/Icons/air.svg" alt="icon" width=15 height=15> **Air** | An AI-native code editor built for agentic development workflows. | [Website](https://air.dev/) | `Mac` `Windows` `Linux` | Freemium, Proprietary | `AI-Native` `Agentic` |
| <img src="Resources/Icons/thinkrail.svg" alt="icon" width=15 height=15> **ThinkRail** | The worktree IDE for the Pi coding agent, pairing isolated git worktree workspaces with spec-driven development. | [Website](https://thinkrail.ai/) <br> [Github](https://github.com/JetBrains/thinkrail) | `Mac` `Windows` `Linux` | Free, Open-Source | `AI-Native` `Spec-Driven` `BYOK` |
...
| <img src="Resources/Icons/lore.svg" alt="icon" width=15 height=15> **Lore** | a next-generation, open source version control system. | [Website](https://lore.org/) <br> [Github](https://github.com/EpicGames/lore) | `Mac` `Windows` `Linux` `API` | Free, Open-Source | `Hosting` `Collaboration` |
